...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public OrderPaymentSaga(OrderDomainService orderDomainService, OrderSagaHelper orderSagaHelper, PaymentOutboxHelper paymentOutboxHelper, ApprovalOutboxHelper approvalOutboxHelper, OrderRepository orderRepository, OrderDataMapper orderDataMapper) {
    ...
    private Order rollbackPaymentForOrder(PaymentResponse paymentResponse) {
        ...
        Order order = findOrder(paymentResponse.getOrderId());
        orderDomainService.cancelOrder(order, paymentResponse.getFailuresMessages());
        orderRepository.save(order);
        return order;
    }
}
